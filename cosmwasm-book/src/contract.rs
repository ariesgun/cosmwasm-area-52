use crate::msg::{AdminsListResp, GreetResp, QueryMsg, InstantiateMsg, ExecuteMsg};
use cosmwasm_std::{
    coins, BankMsg,
...
mod exec {
    ...
    pub fn add_members(deps: DepsMut, info: MessageInfo, admins: Vec<String>) 
    ...
    fn instantiation() {
        ...
        let addr = app
            .instantiate_contract(
                ...
                &InstantiateMsg { admins: vec![], donation_denom: "".to_owned(), },
                &[],
                "Contract",
                None,
            )
